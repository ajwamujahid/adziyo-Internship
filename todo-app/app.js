...
function renderTasks() {
    ...
    tasks.forEach((task) => {
        ...
        li.innerHTML = `<span class="flex items-center  gap-2 cursor-pointer  ${task.completed ? "line-through text-gray-400" : ""}">
       <i class="fa-solid fa-circle-check ${task.completed ? "text-green-400" : "text-blue-400"}"></i>
        ${task.text}
      </span>
      ...
      `;
        ...
        const editBtn = (_a = li.querySelector(".fa-pen")) === null || _a === void 0 ? void 0 : _a.parentElement;
        editBtn.addEventListener("click", () => editTask(task.id));
        const delBtn = (_b = li.querySelector(".fa-trash")) === null || _b === void 0 ? void 0 : _b.parentElement;
